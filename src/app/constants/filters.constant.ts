...
filterTypes.set('launch_success', { label: 'Successful Launch', values: Array.of('true', 'false') });
filterTypes.set('land_success', { label: 'Successful Landing', values: Array.of('true', 'false') });
